...
Business Reviewer / Architect Reviewer / Performance Reviewer / Security Reviewer 등이 다루지 않는, 또는 그 역할의 전 단계로서 코드 자체의 오류, 구조, 클린 코드 원칙 위반, 코드 냄새(code smell) 등을 검토합니다.
...
즉, Code Reviewer는 중복되지 않도록, “코드 구현 수준에서의 품질 점검” 범위에 집중해야 합니다.
